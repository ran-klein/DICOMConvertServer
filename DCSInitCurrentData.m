...
function DCSCurrentData = DCSInitCurrentData(source, useTempFiles)
...
elseif strcmpi(DCSCurrentData.hdr.image_type,'static') && isfield(DCSCurrentData.infodcm,'AcquisitionTime') && isfield(DCSCurrentData.infodcm,'AcquisitionDate')
	DCSCurrentData.chklist.frame.mode = 'Explicit'; DCSCurrentData.chklist.frame.field = 'AcquisitionDate';
elseif strcmpi(DCSCurrentData.hdr.image_type,'static') && isfield(DCSCurrentData.infodcm,'ContentTime') && isfield(DCSCurrentData.infodcm,'ContentDate')
...
DCSCurrentData.chklist.useTempFiles = useTempFiles;
